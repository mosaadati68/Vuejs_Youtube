            ...
            <template slot="expand" scope="props">
                <v-container fluid>
                    <v-card light flat text-xs-center>
                        ...
                        <v-card-actions>
                            <v-btn flat @click="activateLink(props.item)" color="success" v-if="!props.item.referral_link.active">فعال کردن  <v-icon right>done_all</v-icon></v-btn>
                            <v-btn flat @click="deactivateLink(props.item)" color="error" v-if="props.item.referral_link.active">غیر فعال کردن <v-icon right>fa-ban </v-icon></v-btn>
                        </v-card-actions>
                        <v-card-title>
                            <v-container fluid>
                                <p class="title info--text">جزئیات حساب کاربری</p>
                                <v-layout row wrap>
                                    <v-flex xs12>
                                    <v-text-field
                                        label="Username"
                                ...
                                <p class="title info--text" v-if="props.item.roles">نقش های کاربر</p>
                                <v-layout row wrap>
                                    <v-flex xs12>
                                        <v-select
                                ...
                                <p class="title info--text" v-if="props.item.permissions">مجوز های کاربر</p>
                                <v-layout row wrap>
                                    <v-flex xs12>
                                ...
                                <p class="title info--text" v-if="props.item.profile">جزیئیات پروفایل</p>
                                <v-layout row wrap>
...
export default {
    ...
    data: () => ({
        ...
        /* table */
        headers: [
            { text: 'شناسه کاربری', value: 'id', align: 'left', sortable: true },
            { text: 'نام', value: 'name', align: 'left', sortable: true },
            { text: 'اسپانسر', value: 'sponsor.name', align: 'left', sortable: true },
            { text: 'آدرس سایت', value: 'referral_link.link', align: 'left', sortable: true },
            { text: 'نقش ها', value: 'roles', align: 'left', sortable: false },
            { text: 'فعالیت ها', value: 'actions', align: 'center', sortable: false }
        ],
        items: [],
        current_user: {},
