<template>
  <main-layout :class="[contentClass]" :style="{ paddingTop: `56px`}">
    <v-parallax src="/img/MaghsoudGroup9-2.jpg">
    ...
    <v-container light>
        <v-layout row wrap >
          <v-flex xs12>
              <h4 light class="text-lg-justify">
                  معرفی گروه کارخانجات مقصود
              </h4>
              <p>
            ...
            <v-card-text>
                ...
                <v-card flat style="background-color:transparent;">
                    ...
                    <v-slide-y-transition>
                        <v-card-text v-show="card.show" v-text="card.tagline" class="accent--text text-lg-right justi">
                        </v-card-text>
                    </v-slide-y-transition>
                </v-card>
            </v-flex>
...
export default {
    ...
    data: () => ({
        ...
        showcase: [
            { color: 'primary', icon: 'fa-eye', show: true, title: 'شرکت سپیده جام', tagline: 'IAMWORLDWIDE aims to be one of the most admired direct sales companies here and around the globe. Armed with a purpose to bring real change in our people’s total well-being including one’s health, prosperity, and balance. By living for others, we help MOVE them to improved lives whatever the situation and no matter the circumstance.', xs: 12, sm: 12, md: 4, lg: 4, xl: 4 },
            { color: 'accent', icon: 'fa-fa', show: true, title: 'شرکت ساینا', tagline: 'IAMWORLDWIDE’s objective is to enrich the lives of our customers, independent distributors, employees, and the community by providing them with the best-in-market business opportunities, and to be at the forefront of bringing world-class quality products to whomever and wherever they may be in the world.', xs: 12, sm: 12, md: 4, lg: 4, xl: 4 },
            { color: 'pink', icon: 'fa-handshake-o', show: true, title: 'شرکت چینی مقصود', tagline: 'مجتمع تولیدی چینی مقصود با مشارکت شرکت سرمایه گذاری بانک ملی ایران و اتحادیه کارکنان دولت (اسکاد) با ظرفیت اسمی سالیانه (3000 تن ) به صورت رسمی در 15 اسفندماه 1373 افتتاح گردید . \n' +
            'این مجتمع به عنوان اولین استفاده کننده از پرس های ایزو استاتیک و کوره های پخت سریع در خاورمیانه با کادری مجرب که تمام دوره های آموزشی لازم را در کشور آلمان سپری نمودند وارد بازار رقابت تولید چینی مظروف گردید .\n' +
            'استفاده از کارشناسان خارجی ، استفاده از تکنولوژی مدرن برای اولین بار ، کمبود مواد اولیه مرغوب فرآوری شده در کشور باعث شد که اولین فرمولهای استفاده در کشور با بیش از 50% مواد خارجی همراه باشد .', xs: 12, sm: 12, md: 4, lg: 4, xl: 4 }
        ],
        values: [
