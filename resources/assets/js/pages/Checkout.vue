    ...
    <v-stepper v-model="step">
        ...
        <v-stepper-header>
            ...
            <template v-for="(active,key) in getActiveSteps">
                ...
                >
                    <span class="primary--text mr-2">{{ active.title }}</span>
                    <small class="info--text mr-2">{{ active.subtitle }}</small>
                </v-stepper-step>

                <v-divider :key="key" v-if="parseInt(key + 1) !== getActiveSteps.length" class="grey lighten-2">
                </v-divider>
