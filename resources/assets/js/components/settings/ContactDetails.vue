<template>
    ...
    >
        <v-container>
            ...
            <v-layout row wrap v-if="hasContactKeys">
                <p class="primary--text">جزئیات تماس</p>
                <v-flex xs12>
                    <v-alert color="primary" icon="warning" value="true">
                            <span class="white--text">** جزیئات تماس به صورت عمومی در سایت نمایش داده می شود **</span>
                    </v-alert>
                </v-flex>
                <v-flex xs12>
                    <v-text-field
            ...
            <v-layout row wrap v-else>
                <v-flex xs12 text-xs-center>
                    <v-card light :class="[contentClass]" flat >
                            <v-card-text>
                            <h4>گزینه تماس برای نمایش وجود ندارد !</h4>
                            <p class="title">ایجاد گزینه تماس</p>
