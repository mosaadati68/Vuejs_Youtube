...
<v-container fluid>
    <form>
        ...
        <v-btn  light color="primary" :loading="addressForm.busy" :disabled="errors.any()"  @click.native="submit()" :class="{primary: !addressForm.busy, error: addressForm.busy}" class="white--text left">یروزرسانی </v-btn>
        </form>
</v-container>
</template>
