...
<v-container fluid>
        ...
        <v-btn light color="primary" :loading="customerForm.busy" :disabled="errors.any()"  @click.native="submit()" :class="{primary: !customerForm.busy, error: customerForm.busy}" class="white--text left">بروزرسانی</v-btn>
</v-container>
</template>
